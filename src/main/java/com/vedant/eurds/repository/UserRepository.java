...
public interface UserRepository extends JpaRepository<User, UUID> {
    ...
    // Get the current failed attempt count atomically after incrementing
    @Query("SELECT u.failedAttemptCount FROM User u WHERE u.username = :username")
    int getFailedAttemptCount(@Param("username") String username);
